...
async function main() {
  ...
  const products = [
    ...
    // Silicone
    { name: "MILKYSIL TIRE POLISH CONCENTRATE", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 108 SP", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 168 HV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 168 LV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 22 SKS", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 297 HV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 297 LV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 303 B", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 305 MR", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 306 HVM", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 30 HV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 320 HV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 320 LV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 33 HV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 36 HV", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 36 HVM", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 36 TPK", categoryId: 4 },
    { name: "MILKYSIL TIRE POLISH S 40 LV", categoryId: 4 },
