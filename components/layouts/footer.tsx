...
const Footer = () => {
    return (
        ...
        <div className="mx-auto max-w-[1400px] px-8 grid grid-cols-2 md:grid-cols-4 gap-12">

            {/* Company Info */}
            <div className="space-y-7 col-span-2 md:col-span-1">
            <Image
                src="/logo-footer.png"
                alt="logo"
                width={500}
            ...
            {/* Company */}
            <div className="pl-10 md:pl-70 order-2 md:order-none">
        ...
        {/* Products */}
        <div className="pl-0 md:pl-25 order-1 md:order-none">
